...
export const dashboardAPI = {
    ...
    getReports: (filters) => api.get('/dashboard/reports', { params: filters })
};
...
export const orderAPI = {
    ...
    updateKitchenStage: (id, stage) => api.put(`/orders/${id}/kitchen-stage`, { stage }),
    markItemPrepared: (orderId, lineId) => api.put(`/orders/${orderId}/lines/${lineId}/prepared`)
};
